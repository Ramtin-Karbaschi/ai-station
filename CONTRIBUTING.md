...
when runtime behavior changed). Do not create feature, release, or
architecture branches. Do not commit editor folders, agent instruction files
(`AGENTS.md`), secrets, model binaries, or runtime state.
