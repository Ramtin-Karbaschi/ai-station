...
class OpenCodeClientContractTests(unittest.TestCase):
    ...
    def test_runtime_install_is_pinned_and_checksum_verified(self) -> None:
        ...
        self.assertIn("grant_wsl_operator_git_group", installer)
        self.assertIn('usermod -aG "$DEV_USER"', installer)
        self.assertIn("core.sharedRepository group", installer)
        self.assertIn("chmod 2775", installer)
        self.assertIn("setfacl", installer)
        ...
        self.assertIn("acl", toolchain["apt_packages"])
