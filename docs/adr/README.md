...
| [008](ADR-008-optional-ornith-heavy-profile.md) | Ornith is a retained coding profile; coder stays the default | Accepted |
...
| [017](ADR-017-ornith-1.5-gguf.md) | Retained Ornith profile uses 1.5 Q4_K_M GGUF; coder stays default | Accepted |
| [018](ADR-018-flux2-dev-comfyui.md) | FLUX.2-dev still images on the retained ComfyUI overlay (never delete) | Accepted |
| [019](ADR-019-optional-qwen38-27b-gguf.md) | Retained Qwen3.8-27B UD-Q4_K_M GGUF + mmproj; general stays default | Accepted |
