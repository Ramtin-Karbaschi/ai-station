...
| [017](ADR-017-ornith-1.5-gguf.md) | Optional Ornith profile uses 1.5 Q4_K_M GGUF; coder stays default | Accepted |
| [018](ADR-018-flux2-dev-comfyui.md) | FLUX.2-dev still images on the experimental ComfyUI overlay | Accepted |
