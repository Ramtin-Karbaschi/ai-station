...
OPENCODE_CODER_MODEL="Qwen3-Coder-30B-A3B-Instruct-Q4"
OPENCODE_GENERAL_MODEL="Qwen3.6-35B-A3B-UD-Q4_K_M"
OPENCODE_REASONING_MODEL="DeepSeek-R1-Distill-Qwen-32B-Q4_K_M"
OPENCODE_ORNITH_MODEL="Ornith-1.0-35B-Q4_K_M"
OPENCODE_PROJECT_ID="opencode"
OPENCODE_API_KEY_PLACEHOLDER="__AI_STATION_OPENCODE_API_KEY__"
OPENCODE_ALLOWED_MODELS="${OPENCODE_CODER_MODEL},${OPENCODE_GENERAL_MODEL},${OPENCODE_REASONING_MODEL},${OPENCODE_ORNITH_MODEL}"
